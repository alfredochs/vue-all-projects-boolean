  ...
  <div>
    <div class="container-generale-ps">
      ...
      >
        ...
        <div class="container">
          <div class="col-12 text-white text-start container-text-slide-ps">
            <h3>{{ image.titolo }}</h3>
            <p>
              {{ image.sottotitolo }}
            </p>
    ...
    <!-- small-cards -->
    <div class="container-small-cards container p-4 d-flex justify-content-center">
      <div class="row row-cols-2 row-cols-sm-3">
        <div
          ...
          :key="i"
        >
          <div class="my-small-card" @click="imgCurr(i)">
    ...
    return {
      imgList: [
        ...
        },
        {
          ...
          sottotitolo:
            "Ratchet and Clank recover the Dimensional Map but are ambushed by Emperor Nefarious and banished through a rift. Kit transforms into her Warbot form to try and stop Emperor Nefarious, shocking Rivet, but Kit ends up being banished through a rift as well.",
        },
        {
          img: require("../../assets/Playstation/returnal-listing-thumb-01-ps5.jpg"),
          titolo: "Returnal",
          sottotitolo:
            "Third-person shooter, roguelike. Mode(s) Single-player, multiplayer. Returnal is a third-person shooter roguelike video game developed by Housemarque and published by Sony Interactive Entertainment. It was released for the PlayStation 5 on April 30, 2021.",
        },
        {
          img: require("../../assets/Playstation/gow-jumbo.jpeg"),
          titolo: "God Of War",
          sottotitolo:
            "God of War is the eighth installment in the franchise overall. Unlike previous installments, this game focuses on Norse mythology and follows an older and more seasoned Kratos and his new son Atreus in the years since God of War III. The game released on April 20, 2018, and is currently exclusive to the PlayStation 4.",
        },
      ],
      currentImg: 0,
    };
